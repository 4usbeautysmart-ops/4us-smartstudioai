    ...
    responseSchema: {
      ...
      properties: {
        consultancy: {
          type: Type.STRING,
          description:
            "Uma consultoria completa, extensa e detalhada em Português cobrindo formato do rosto, análise detalhada do tom de pele, sugestões de maquiagem e acessórios.",
        },
        palette: {
          type: Type.ARRAY,
          description:
            "Uma paleta de cores recomendada com 6 a 8 cores intensas, vibrantes e com alto contraste para um look moderno.",
          items: {
            type: Type.OBJECT,
            properties: {
              hex: {
        ...
        cuts: {
          ...
          items: {
            ...
            properties: {
              ...
              description: {
                type: Type.STRING,
                description: "Por que combina com o rosto",
              },
              technicalPrompt: {
                type: Type.STRING,
                description:
          ...
          prompts: {
            ...
            properties: {
              ...
              side: {
                type: Type.STRING,
                description:
                  "Prompt técnico em INGLÊS para a visão LATERAL (SIDE VIEW).",
              },
              back: {
                type: Type.STRING,
                description:
                  "Prompt técnico em INGLÊS para a visão DE COSTAS (BACK VIEW).",
              },
            },
